---
description: Scaffold the Forge repo (directories, templates) for first-time use.
---

Set up this Forge repository for first-time use by running the init script from the repo root:
